...
category: Governance
metadata:
  canonical: https://www.soranauts.com/polkadot-governance-its-flaws-and-a-case-for-true-decentralization
---
...
Decentralization helps everyone have a say in decisions. Using smart contracts makes voting secure and fair. To fight risks in [DeFi](https://www.soranauts.com/difference-between-blockchain-and-defi), the plan includes safer practices for handling money.
...
[Polkadot's governance system](https://www.soranauts.com/polkadot-sora-governance-model) is built on three parts. Each part helps the network run well and change when needed.
...
More voices now help shape its path towards better governance and decentralization in [blockchain technology](https://www.soranauts.com/polkadot-architecture-guide).
