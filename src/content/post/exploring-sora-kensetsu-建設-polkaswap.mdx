...
title: "Exploring SORA Kensetsu: A Comprehensive Guide on Polkaswap"
...
image: ~/assets/images/exploring-sora-kensetu-建設-polkaswap.jpg
category: Ecosystem
metadata:
  canonical: https://www.soranauts.com/exploring-sora-kensetsu-建設-polkaswap
---
...
And guess what? People who have [XOR tokens](https://www.soranauts.com/sora-xor-token-supply-explained) get to make important decisions on how everything runs!
...
-   To create KUSD, you can use [TBCD](https://www.soranauts.com/soras-token-bonding-curve-dollar-tbcd-explained) instead of making new XOR tokens, keeping the number of XORs low and helping stability.
...
The plan is to use extra secure stablecoins that hold different tokens as safety. These include [XOR, VAL, PSWAP](https://www.soranauts.com/deep-dive-into-xor-val-and-pswap), XST, XSTUSD, and TBCD. The big goal here is making less XOR available out there.
...
Reducing the number of XOR tokens out there is a big part of SORA Kensetsu's plan. By doing this, they hope to make people more confident in the [SORA economy](https://www.soranauts.com/sora-blockchain-new-world-economic-order). Think about it like this – when there are fewer tokens moving around, each one can become more valuable.
