...
category: Tokenomics
metadata:
  canonical: https://www.soranauts.com/sora-xor-token-supply-explained
---
...
Money is like the lifeblood of an [economy](https://www.soranauts.com/sora-blockchain-new-world-economic-order), and how much there is can really matter. Think about it this way: if you keep adding water to a cup, eventually it will overflow. That's what happens when too much money gets into the system; they call it inflation because prices start going up.
...
Sure! The [TBC](https://www.soranauts.com/soras-token-bonding-curve-dollar-tbcd-explained) is like a smart contract that controls how many new XOR tokens are made and their sell price. It helps keep things fair and stable in our changing world economy.
