...
category: Blockchain
metadata:
  canonical: https://www.soranauts.com/polkadot-sora-governance-model
---
...
- SORA uses a special tool called a [token bonding curve](https://www.soranauts.com/soras-token-bonding-curve-dollar-tbcd-explained) to keep the value of its coins stable. More people wanting XOR makes the price go up gently, and fewer people wanting it makes the price drop slowly.
...
In the dynamic dance of governance, [Polkadot’s architecture](https://www.soranauts.com/polkadot-architecture-guide) forms the stage upon which SORA's innovative model performs—flexible, adaptive, and underpinned by stakeholder consensus.
...
With SORA's help, even [small countries](https://www.soranauts.com/soramitsu-pilots-central-bank-of-solomon-islands-cbdc) can play big in the global economy without being pushed around by others' rules.
