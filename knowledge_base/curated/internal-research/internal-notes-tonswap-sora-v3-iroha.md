...
slug: "internal-notes-tonswap-sora-v3-iroha"
source: "internal-research"
source_url: "internal://soranauts/internal-research/internal-notes-tonswap-sora-v3-iroha"
...
tags: ["internal", "tonswap", "sora-v3", "iroha", "governance", "nexus", "hub-chain", "iroha3"]
---
...
## Timeline and Development Philosophy

While SORA v3 (Nexus) development targets a 2025 launch window, **no specific date is guaranteed**. The roadmap depends on coordinated progress across SORAMITSU, Iroha core, and SORA governance initiatives.

Delays or adjustments may occur as the teams prioritize:
- **Security audits** and formal verification of Iroha 3 components,  
- **Performance testing** on Fujiwara and staging environments, and  
- **Cross-chain stability** with TON, Polkadot, and other bridge partners.

As a guiding principle, SORA's engineering philosophy values **safety, correctness, and efficiency** over arbitrary release dates. The approach ensures that every feature—especially governance logic and bridge infrastructure—is validated before deployment.
