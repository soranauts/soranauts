          ...
          >
            ...
            <div className="flex items-center gap-2 text-xs">
              <span className={`px-2 py-1 rounded-full font-medium ${
                term.category === 'token' ? 'bg-yellow-100 text-yellow-800' :
                term.category === 'technology' ? 'bg-blue-100 text-blue-800' :
                term.category === 'governance' ? 'bg-purple-100 text-purple-800' :
                term.category === 'defi' ? 'bg-green-100 text-green-800' :
                term.category === 'network' ? 'bg-red-100 text-red-800' :
