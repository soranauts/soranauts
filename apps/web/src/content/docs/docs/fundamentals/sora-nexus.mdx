...
[View SORA Nexus Wiki Page](https://wiki.sora.org/sora-v3) | [SORA Nexus Whitepaper (PDF)](https://sora.org/sora_nexus_whitepaper.pdf)
:::
...
![SORA Nexus Architecture Overview](/sora-nexus-architecture-overview.webp)
...
<Aside type="tip" title="Understanding the Flow">
Transactions enter through **data spaces** (sovereign domains), get processed in **parallel lanes** (for speed), and are finalized in the **merge ledger** (for global ordering). This three-tier design enables SORA Nexus to scale horizontally while preserving deterministic finality.
</Aside>
...
The technology powering SORA Nexus has real-world validation:

- **Bakong (Cambodia)** — Built on Hyperledger Iroha, processed transactions equivalent to 330% of Cambodia's GDP in 2024
- **Digital Kina (Papua New Guinea)** — CBDC proof-of-concept demonstrating 24/7 instant payments
- **Solomon Islands & Palau** — Additional CBDC pilots connecting national systems to decentralized finance
