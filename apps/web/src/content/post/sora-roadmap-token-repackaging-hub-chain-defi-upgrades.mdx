...
Participation is coordinated through the official [SORA Wiki](https://wiki.sora.org) and community governance channels, where public validator access will be announced. For underlying ledger details, review **Hyperledger Iroha 2 docs** (`https://iroha.readthedocs.io/`).
