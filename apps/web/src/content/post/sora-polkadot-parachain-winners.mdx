...
updateDate: 2025-10-28T00:00:00Z
...
[Crowdloan campaigns](https://polkadot.com/auctions/) proved the strength of community participation.  
...
SORA v2 is built on [Hyperledger Iroha 2](https://iroha.tech/), and **SORA v3 (Nexus)** will migrate to **Iroha 3**, marking a shift toward **sovereign interoperability** where governance and consensus operate fully within SORA's own network.
...
- **[Hub-chain architecture](https://wiki.sora.org/sora-v3)** being developed on Hyperledger Iroha 3 — a next-generation version introducing enhanced modularity, performance, and consensus mechanisms  
- **[Kensetsu stablecoin system](/exploring-sora-kensetsu-polkaswap)** (KUSD)  
- **Integrated [Polkaswap](https://medium.com/polkaswap-community-collective/how-to-use-the-hashi-bridge-eb69e88bc87) bridge layer** for DeFi access  
...
- [SORA Medium Updates](https://medium.com/sora-xor)  
