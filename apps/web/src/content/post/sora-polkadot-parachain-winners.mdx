...
SORA’s transition to [Hyperledger Iroha 2](https://iroha.tech/) marks a shift toward **sovereign interoperability**, where governance and consensus operate fully within SORA’s own network.
...
**SORA v3 introduces:**
- **[Hub-chain architecture](https://wiki.sora.org/sora-v3)** built on Hyperledger Iroha 2  
...
SORA v3 runs on **[Hyperledger Iroha 2](https://docs.iroha.tech/get-started/)** — a permissioned-by-consensus framework that supports hub-chain connectivity without DOT bonding or lease periods, while leaving the door open for future bridge integrations with Polkadot or other networks.
</details>
