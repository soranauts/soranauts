...
As of **November 2025**, Kensetsu's architecture is among the first components planned for **[SORA v3 (Nexus)](/sora-v3-revolutionizing-tokenomics-and-defi-on-polkadot)**, which is being developed on <a href="https://iroha.readthedocs.io/" target="_blank" rel="noopener noreferrer">Hyperledger Iroha 3</a> — a next-generation version introducing enhanced modularity, performance, and consensus mechanisms. This bridges open-source transparency with compliant, enterprise-grade security. SORA v2, based on Iroha 2, provides the foundation for this transition.
...
As of **November 2025**, Kensetsu is designed to support **cross-stablecoin swap modules**, conceptually similar to MakerDAO’s Peg Stability Module (PSM).
...
> 🧠 **Learn More**
> • <a href="https://wiki.sora.org/kusd.html" target="_blank" rel="noopener noreferrer">KUSD on SORA Wiki</a>
