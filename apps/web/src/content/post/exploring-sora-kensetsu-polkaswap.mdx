...
> **TL;DR:**
> As of **December 2025**, SORA Kensetsu is an over-collateralized vault system that lets users mint **KUSD**, a stablecoin backed by approved collateral such as XOR, VAL, PSWAP, TBCD, ETH, and DAI.
...
Before looking at the detailed parameters, it helps to understand how Kensetsu fits into SORA's broader architecture.
...
Modeled after MakerDAO's collateralized debt position design but tailored to SORA's unique tokenomics, Kensetsu introduces **vaults**, **liquidation mechanics**, and **stability fees** that maintain a strong USD peg and aim to reduce volatility in daily DeFi use.

As of **December 2025**, Kensetsu's architecture is among the first components planned for **[SORA v3 (Nexus)](/sora-nexus-complete-guide)**, which is being developed on <a href="https://iroha.readthedocs.io/" target="_blank" rel="noopener noreferrer">Hyperledger Iroha 3</a> — a next-generation version introducing enhanced modularity, performance, and consensus mechanisms. This bridges open-source transparency with compliant, enterprise-grade security. SORA v2, based on Iroha 2, provides the foundation for this transition.

---

## How the KUSD Stablecoin Works

<a href="https://wiki.sora.org/kusd.html" target="_blank" rel="noopener noreferrer">KUSD</a> — *Kensetsu USD* — is an over-collateralized stablecoin minted through Kensetsu vaults.
...
Using **TBCD instead of minting new XOR** for KUSD creation prevents supply expansion, helping keep the system balanced.
...
<a href="https://wiki.sora.org/kensetsu-vaults.html" target="_blank" rel="noopener noreferrer">Kensetsu Vaults</a> are at the core of the protocol — smart vaults that hold collateral and track outstanding KUSD debt.
...
<a href="https://wiki.sora.org/ken.html" target="_blank" rel="noopener noreferrer">Kensetsu Token (KEN)</a> powers liquidity and incentives across the Kensetsu ecosystem.
...
As of **December 2025**, Kensetsu is designed to support **cross-stablecoin swap modules**, conceptually similar to MakerDAO's Peg Stability Module (PSM).
These modules are intended to let users swap between approved stablecoins — **KUSD**, **XSTUSD**, and **TBCD** — at low slippage, enhancing liquidity and price stability when fully deployed.
...
**SORA Kensetsu** is a core component of SORA's monetary design rather than a standalone DeFi module.
Through vault-based collateralization, decentralized governance, and token-driven incentives, Kensetsu provides a structured framework for issuing and managing KUSD within open finance.

As **SORA v3** unfolds on **Hyperledger Iroha**, Kensetsu and KUSD are positioned to support a more transparent, interoperable, and community-driven digital economy for SORA and Polkaswap users.
...
## Learn More About Kensetsu

### Official Documentation
- <a href="https://wiki.sora.org/kusd.html" target="_blank" rel="noopener noreferrer">KUSD Stablecoin Guide</a>
- <a href="https://wiki.sora.org/kensetsu-vaults.html" target="_blank" rel="noopener noreferrer">Kensetsu Vaults Documentation</a>
- <a href="https://wiki.sora.org/ken.html" target="_blank" rel="noopener noreferrer">KEN Token Mechanics</a>

### Related Guides
- [SORA's Token Bonding Curve Dollar (TBCD) Explained](/soras-token-bonding-curve-dollar-tbcd-explained)
- [Understanding SORA's (XOR) Token Supply](/sora-xor-token-supply-explained)
