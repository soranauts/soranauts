...
Kensetsu’s architecture is among the first components of **[SORA v3](/sora-v3-revolutionizing-tokenomics-and-defi-on-polkadot)**, built on **[Hyperledger Iroha 2](https://iroha.readthedocs.io/)** — bridging open-source transparency with compliant, enterprise-grade security.
...
- Interoperable across SORA, [Polkaswap](/soramitsu-sora-polkaswap-the-complete-guide-to-defi-innovation), and other networks  
...
4. **Automatic protection:** If your ratio drops too low, the system liquidates a portion via [Polkaswap](/soramitsu-sora-polkaswap-the-complete-guide-to-defi-innovation).  
