...
Where fungible tokens like **[XOR](/deep-dive-into-xor-val-and-pswap)** or **USDT** are interchangeable, each NFT stands alone with distinct properties.
...
For a broader introduction to DeFi concepts, see [**The DeFi Crash Course**](/defi-protocols-beginners-crash-course).
...
- **NFT bridging is not available as of December 2025**  
- [SORA v3's](/sora-nexus-complete-guide) shift to **Hyperledger Iroha** lays future groundwork for interoperability
...
As **[SORA v3](/sora-nexus-complete-guide)** evolves on **Hyperledger Iroha**, NFTs will gain stronger interoperability and broader use across applications and networks.
