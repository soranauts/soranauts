...
**[SORA v3 (Nexus)](/sora-nexus-complete-guide)**, being developed on **Hyperledger Iroha 3**, moves governance off Substrate toward a **sovereign, interoperable layer** that preserves SORA's principles of transparency, inclusivity, and non-debt-based coordination. Iroha 3 introduces enhanced modularity, performance, and consensus mechanisms.
...
- **Economic link:** Polkaswap, [Kensetsu](/exploring-sora-kensetsu-polkaswap), and [TBCD](/soras-token-bonding-curve-dollar-tbcd-explained) tie governance to liquidity and funding flows.  
...
These lessons now inform how SORA v3 is being built: not as a Polkadot parachain, but as an **interoperable hub** that connects to ecosystems like Polkaswap, TONSWAP, and other DeFi networks through cross-chain bridges. For a full ecosystem overview, see [SORA Ecosystem Explained](/sora-ecosystem-explained).  
...
### Primary sources
- <a href="https://wiki.polkadot.network/docs/learn-polkadot-opengov" target="_blank" rel="noopener noreferrer">Polkadot OpenGov documentation</a>
- <a href="https://docs.substrate.io/reference/frame-pallets/#governance" target="_blank" rel="noopener noreferrer">Substrate FRAME governance pallets</a>
- <a href="https://wiki.polkadot.com/learn/learn-polkadot-opengov/#referenda" target="_blank" rel="noopener noreferrer">Polkadot referenda</a>
- <a href="https://docs.iroha.tech/" target="_blank" rel="noopener noreferrer">Hyperledger Iroha documentation</a> (Iroha 2 is the current framework for SORA v2; SORA v3 will migrate to Iroha 3)
- <a href="https://docs.iroha.tech/blockchain/permissions.html" target="_blank" rel="noopener noreferrer">Iroha permissions model</a>
- <a href="https://sora.org/" target="_blank" rel="noopener noreferrer">SORA official site</a>
- <a href="https://medium.com/sora-xor" target="_blank" rel="noopener noreferrer">Soramitsu Medium – SORA updates</a>

### Secondary and adjacent
- <a href="https://wiki.sora.org/polkaswap/polkaswap-faq.html" target="_blank" rel="noopener noreferrer">Polkaswap documentation</a>
- <a href="https://wiki.sora.org/ken.html" target="_blank" rel="noopener noreferrer">Kensetsu documentation</a>
- <a href="https://wiki.sora.org/tbcd.html" target="_blank" rel="noopener noreferrer">TBCD overview</a>
- <a href="https://sora.subscan.io/" target="_blank" rel="noopener noreferrer">Subscan SORA governance (historical)</a>
