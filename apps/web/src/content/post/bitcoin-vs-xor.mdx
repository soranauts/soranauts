...
title: "Bitcoin vs XOR: Competing Visions for a New Economic Order"
...
- SORA v2, based on **Hyperledger Iroha 2**, laid the groundwork for **[SORA v3 (Nexus)](/sora-nexus-complete-guide)**, which will migrate to **Iroha 3** — introducing a modular, high-performance hub chain for sustainable growth and cross-chain interoperability.
...
SORA began within the Polkadot ecosystem but has evolved into an independent hub chain. SORA v2 is built on **Hyperledger Iroha 2**, and **[SORA v3 (Nexus)](/sora-nexus-complete-guide)** will migrate to **Iroha 3**, focused on cross-chain interoperability.
</details>
...
### 🌐 Academic & Research
- **<a href="https://bitcoin.org/bitcoin.pdf" target="_blank" rel="noopener noreferrer">Bitcoin Whitepaper</a>** — Satoshi Nakamoto (2008)  
- **<a href="https://sora.org/assets/how-sora-works/the-case-for-xor.pdf" target="_blank" rel="noopener noreferrer">*The Case for XOR* (PDF)</a>** — *Makoto Takemiya*, SORAMITSU Co., Ltd. (2023)  
- **<a href="https://professorwerner.org/pubs/towards-a-new-monetary-paradigm-a-quantity-theorem-of-disaggregated-credit-with-evidence-from-japan/" target="_blank" rel="noopener noreferrer">Disaggregated Quantity Theory of Money</a>** — *Professor Richard Werner* (1997)
