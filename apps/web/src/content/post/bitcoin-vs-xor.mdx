...
- Built on **Hyperledger Iroha 2**, SORA v3 is an interoperable hub chain for sustainable growth.
...
| **Consensus** | Proof-of-Work | **Sumeragi (BFT, Iroha 2)** |
...
In this sense, **SORA’s inflation is credit-backed**—it corresponds to measurable real-world use rather than arbitrary monetary expansion. Every minted XOR represents value creation, liquidity support, or public funding approved by governance, ensuring credit flows toward growth instead of asset inflation.

As SORA transitions to its **Hyperledger Iroha 2 hub chain**, interoperability expands across Polkaswap, TONSWAP, and other DeFi ecosystems.  
The **Sumeragi BFT consensus** replaces traditional Proof-of-Authority models, combining enterprise-grade efficiency with transparent community oversight.
