...
PoW is proven but resource-intensive, with slower governance agility and higher operational barriers. For a detailed comparison of Bitcoin's monetary model versus SORA's approach, see ["Bitcoin vs XOR: Competing Visions for a New World Economic Order"](/bitcoin-vs-xor).

## Proof of Stake fundamentals

PoS selects **validators** by their bonded token stake and proven reliability. SORA specifically uses **NPoS (Nominated Proof-of-Stake)**, where nominators delegate stake to trusted validators, adding an extra layer of community participation. Instead of electricity, they risk losing deposits (slashing) for misbehavior. Modern PoS systems—**Ethereum 2.0**, **Polkadot**, **SORA**—add randomness, delegation, and governance modules to maintain decentralization as participation scales.
...
**SORA** currently operates PoS on **Hyperledger Iroha 2** while preparing **[SORA v3 "Nexus"](/sora-nexus-complete-guide)** on Iroha 3. The **Fujiwara testnet** runs the next-gen validator stack: operators bond XOR, earn VAL-denominated rewards, and trial governance before mainnet deployment.  
