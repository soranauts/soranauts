...
For how they work together, see [**How Polkaswap and TONSWAP Work Together on SORA**](/how-polkaswap-and-tonswap-work-together-on-sora).
...
As of late 2025:  
- **SORA** is exploring lending markets built around KUSD. The [**Apollo Protocol**](/apollo-protocol-sora-network) provides community-driven lending infrastructure, though production readiness varies.  
...
- **KUSD** serves as SORA’s decentralized stable asset, following earlier models like TBCD. For details on minting KUSD, see [**SORA Kensetsu Explained**](/exploring-sora-kensetsu-polkaswap).  
...
- **[SORA v3 (Nexus)](/sora-nexus-complete-guide)**, built on Iroha 3 (Fujiwara), is designed with stronger native cross-chain capabilities.
...
TONSWAP’s fee model allocates **10% of trading fees to buy back and burn XOR** — creating a direct, automated economic connection between the two networks.
