...
- **Collateral:** Locked in **Kensetsu vaults** to mint **KUSD (Kensetsu USD)**, SORA's stablecoin used as a base pair on Polkaswap and TONSWAP. See also: ["Understanding XOR Token Supply"](/understanding-the-increase-in-the-sora-xor-token-supply-and-its-role).
...
As SORA transitions to **v3 (Nexus)**, governance is expected to evolve into a more modular **Parliament-style** model on **Hyperledger Iroha 3**, maintaining transparency and decentralization. For a complete technical overview, see ["SORA Nexus: Complete Guide"](/sora-nexus-complete-guide).
