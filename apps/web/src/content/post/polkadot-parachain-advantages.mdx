...
updateDate: 2025-10-30T00:00:00Z
title: "What Are Polkadot Parachains? Scalability, Shared Security, and XCM"
...
> Learn more in the [Polkadot architecture overview](https://wiki.polkadot.network/docs/learn-architecture) and the [XCM documentation](https://wiki.polkadot.network/docs/learn-xcm).
...
> Learn more about [slot auctions](https://polkadot.com/auctions/) and [parathreads](https://polkadot.com/blog/parathreads-parathreads-pay-as-you-go-parachains/).
...
Projects like [SORA](/sora-polkadot-parachain-winners) used Polkadot’s parachain model to experiment with cross-chain DeFi, liquidity aggregation, and governance before evolving toward its own sovereign Iroha-based hub chain.  
...
- [Polkadot architecture overview](https://wiki.polkadot.network/docs/learn-architecture)  
- [XCM overview](https://wiki.polkadot.network/docs/learn-xcm)  
- [Parachain slot auctions](https://polkadot.com/auctions/)  
