...
-   **SORA v3 (Nexus):** Being developed on the [Hyperledger Iroha 3](https://iroha.tech/) framework — a next-generation version introducing enhanced modularity, performance, and consensus mechanisms — this version focuses on scalability, security, and interoperability to serve as a hub for various blockchain applications. SORA v2, built on Iroha 2, laid the groundwork.
