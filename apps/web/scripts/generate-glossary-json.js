...
// Import the existing glossary data
const { soraGlossary } = await import('../src/data/sora-glossary.ts');
...
// Generate aliases from term (only actual alternative names, not related concepts)
